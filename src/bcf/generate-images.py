...
def generate_images(model_name, prompts_path, save_path, device='cuda:0', guidance_scale = 7.5, image_size=512, ddim_steps=100, num_samples=10, from_case=0, till_case=1000000, base='1.4'):
    ...
    if base == '1.4':
        model_version = 'C:/Users/24857/.cache/huggingface/hub/models--CompVis--stable-diffusion-v1-4/snapshots/133a221b8aa7292a167afc5127cb63fb5005638b/'
    elif base == '2.1':
    ...
    text_encoder.text_model.load_state_dict(torch.load('F:/ICT/Model_Editing/code/my_code/BCF/model/edited_text_encoder_NSFW_20.pt'))
...
if __name__=='__main__':
    ...
    parser.add_argument('--model_name', help='name of model', type=str, default='original')
    parser.add_argument('--prompts_path', help='path to csv file with prompts', type=str, default='./data/NSFW_forget/unsafe-prompts4703.csv')
    parser.add_argument('--save_path', help='folder where to save images', type=str, default='images/results/contrstive_text/artist_forget')
